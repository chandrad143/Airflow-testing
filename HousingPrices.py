...
#develop some basic strategies to reduce model error.
...
#plot the line we've learned, drawing from the model's bias term and feature weight, together with the scatter plot
...
#Using the 'Population' as feature:
